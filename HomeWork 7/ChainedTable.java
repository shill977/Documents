...
public class ChainedTable
{
   ...
   **/
   ...
   {
     ChainedHashNode head= table[hash(key)];
   ...
   **/
   public Object put(Object key, Object element)
   {
      ...
      // Set cursor so that it refers to
      // the node that already contains the specified key.
      if (containsKey(key) == true){
        cursor.link = table[hash(key)];
        table[hash(key)] = cursor;
      }
       
      //If there is no such node, then the student code should set cursor to null.
